...
export const listCategories: RequestHandler = async (request, response) => {
  response.json({
    success: true,
    data: await categoryService.list(request.authUser?.role === "Admin"),
  });
};
export const getCategory: RequestHandler = async (request, response) => {
  ...
  response.json({
    success: true,
    data: await categoryService.get(id, request.authUser?.role === "Admin"),
  });
};
export const createCategory: RequestHandler = async (request, response) => {
  ...
  response
    ...
    .json({
      success: true,
      data: await categoryService.create(input),
...
export const updateCategory: RequestHandler = async (request, response) => {
  ...
  response.json({
    success: true,
    data: await categoryService.update(id, input),
